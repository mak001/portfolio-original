...
CustomHtmlEditorConfig::get('cms')->enablePlugins('media', 'fullscreen', 'colorpicker', 'importcss', 'codesample');
CustomHtmlEditorConfig::get('cms')->enablePlugins(array(
	'ssbuttons' => Director::absoluteBaseURL() . '/' . TINYMCE4_DIR . '/thirdparty/tinymce_ssbuttons/editor_plugin_src.js'
));
...
CustomHtmlEditorConfig::get('cms')->insertButtonsBefore('code', 'codesample');
